  ...
  return (
    <Container className="mt-4">
      ...
      <Card className="mb-4 shadow-sm border-0">
        <Card.Body className="p-3">
          <Row className="g-3 align-items-end">
            ...
            <Col md={3}>
              <Form.Label className="fw-semibold">Posts per Page</Form.Label>
              <Form.Select value={postsPerPage} onChange={handlePostsPerPage}>
      ...
      <Card className="p-4 mb-4 shadow-sm border-0">
        <h5 className="fw-bold mb-3 text-dark">Create New Post</h5>
        <Row className="g-3">
          <Col md={6}>
          ...
          {posts.length === 0 ? (
            ...
            posts.map((post) => (
              <Col xs={12} md={6} lg={4} key={post._id}>
                <Card className="h-100 shadow-sm border-0 rounded-4 overflow-hidden transition-all hover-shadow-lg">
                  <Card.Body className="p-4">
                    ...
                    <small className="text-muted d-block mb-3">
                      <i>Due: {new Date(post.scheduleDate).toLocaleString()}</i>
                    </small>
                    <div className="d-flex gap-2">
                      <Button
                        variant="outline-warning"
                        size="sm"
                        className="rounded-pill px-3 py-1 fw-semibold transition-all"
