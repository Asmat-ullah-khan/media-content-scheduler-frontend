...
function Postlist() {
  ...
  return (
    <Container className="mt-4">
      ...
      {/* Create Post Form */}
      <Card className="p-4 mb-4 shadow-sm border-0 rounded-3">
        ...
        <Row className="g-3">
          ...
          <Col md={3}>
            ...
            <div className="d-flex flex-column gap-2 p-2 border rounded-3 bg-light">
                ...
                <Form.Check
                  ...
                  label={
                    <span className="d-flex align-items-center">
                      ...
                      <small className="text-muted">Share on {platform}</small>
                    </span>
                  }
          ...
          <Col md={2}>
            ...
            <Form.Control
              ...
              className="rounded-3"
            />
            <small className="text-muted">Future date only</small>
          </Col>
